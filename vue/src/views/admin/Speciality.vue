  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="neirong" label="专业描述" show-overflow-tooltip></el-table-column>
        <el-table-column prop="collegeName" label="所属学院" show-overflow-tooltip></el-table-column>
        <el-table-column prop="xuefen" label="学分限定" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="neirong" label="专业描述">
          <el-input type="textarea" :rows="5" v-model="form.neirong" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="xuefen" label="学分限定">
          <el-input v-model="form.xuefen" autocomplete="off"></el-input>
        </el-form-item>
